...
export class Matrix4 {
  ...
  apply(vector) {
    ...
    vector.divide(
      this.buffer[3] * _x + this.buffer[7] * _y + this.buffer[11] * _z + this.buffer[15]
    );
  ...
  multiply(other) {
    ...
    this.buffer[0] =
      _00 * other.buffer[0] + _10 * other.buffer[1] + _20 * other.buffer[2] + _30 * other.buffer[3];
    this.buffer[1] =
      _01 * other.buffer[0] + _11 * other.buffer[1] + _21 * other.buffer[2] + _31 * other.buffer[3];
    this.buffer[2] =
      _02 * other.buffer[0] + _12 * other.buffer[1] + _22 * other.buffer[2] + _32 * other.buffer[3];
    this.buffer[3] =
      _03 * other.buffer[0] + _13 * other.buffer[1] + _23 * other.buffer[2] + _33 * other.buffer[3];

    this.buffer[4] =
      _00 * other.buffer[4] + _10 * other.buffer[5] + _20 * other.buffer[6] + _30 * other.buffer[7];
    this.buffer[5] =
      _01 * other.buffer[4] + _11 * other.buffer[5] + _21 * other.buffer[6] + _31 * other.buffer[7];
    this.buffer[6] =
      _02 * other.buffer[4] + _12 * other.buffer[5] + _22 * other.buffer[6] + _32 * other.buffer[7];
    this.buffer[7] =
      _03 * other.buffer[4] + _13 * other.buffer[5] + _23 * other.buffer[6] + _33 * other.buffer[7];
    ...
    const zli =
      ...
      Math.sqrt(
        this.buffer[2] * this.buffer[2] +
          this.buffer[6] * this.buffer[6] +
          this.buffer[10] * this.buffer[10]
      );
