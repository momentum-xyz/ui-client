...
import {IconSvg, ItemCard, ImageSizeEnum} from '@momentum-xyz/ui-kit';

import {getImageAbsoluteUrl} from 'core/utils';
import {WorldInfoModelInterface} from 'core/models';

import * as styled from './WorldsStakedList.styled';
...
const WorldsStakedList: FC<PropsInterface> = ({worldsStakedIn, onVisitWorld, onSelectWorld}) => {
  const {t} = useI18n();
...
export default observer(WorldsStakedList);
