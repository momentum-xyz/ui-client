...
OUTPUT='./public/env-config.js'

# Recreate config file
rm -rf $OUTPUT
touch $OUTPUT

echo "var base_url = \"https://dev.odyssey.ninja\";" >> $OUTPUT
echo "var frontend_url = window.location.protocol + \"//\" + window.location.host;" >> $OUTPUT
...
echo "  UNITY_CLIENT_URL: \"https://dev.odyssey.ninja/unity\"," >> $OUTPUT
